<template>
  <div
    class="card bg-base-100/80 backdrop-blur-md shadow-2xl border border-success/20 hover:shadow-[0_25px_60px_rgba(30,215,96,0.25)] hover:border-success/40 transition-all duration-500 hover:-translate-y-1 h-full group relative overflow-hidden"
    v-bind="$attrs"
  >
