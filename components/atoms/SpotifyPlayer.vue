<template>
  <div class="card bg-base-100 shadow-sm h-full" v-bind="$attrs">
    <div class="card-body p-4 flex flex-col">
      ...
      <div v-if="embedSrc" class="rounded-xl overflow-hidden bg-base-200 flex-1 min-h-0">
        <iframe
          :src="embedSrc"
      ...
      <div v-else class="flex flex-col items-center justify-center flex-1 bg-base-200 rounded-xl">
